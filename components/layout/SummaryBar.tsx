...
export function SummaryBar() {
  ...
  return (
    <div className="border-b border-zinc-200 dark:border-white/[0.06] bg-white/60 dark:bg-zinc-950/60 backdrop-blur">
      <div className="flex flex-wrap items-center gap-x-6 sm:gap-x-8 gap-y-2 px-4 sm:px-5 py-2.5 text-xs">
        <div className="flex items-center gap-2">
          <span className="text-zinc-500">Today</span>
          <span className="text-zinc-800 dark:text-zinc-100 font-semibold">{kpis.totalToday}</span>
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-zinc-800 dark:text-zinc-100 font-semibold">{kpis.cleared}</span>
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-zinc-800 dark:text-zinc-100 font-semibold">{kpis.flagged}</span>
          <span className="text-zinc-500">flagged</span>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-zinc-500">Avg score</span>
          <span className="text-zinc-800 dark:text-zinc-100 font-semibold">{kpis.avgScore}</span>
        </div>
        <div className="flex items-center gap-2">
