...
export function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex lg:fixed lg:inset-y-0 lg:left-0 lg:w-60 lg:flex-col lg:border-r lg:border-white/[0.06] lg:bg-zinc-950/70 lg:backdrop-blur">
